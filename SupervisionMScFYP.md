...
to **Computer Vision** and **Data Science** e.g. **Machine learning**, Neural Networks, **Deep Learning**, AI, Data Visualisation and Statistics (log in at [portal.cs.nuim.ie/](https://portal.cs.nuim.ie/) to see list of projects).
